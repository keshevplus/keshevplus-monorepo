...
const BookingModal: React.FC<BookingModalProps> = ({ open, onOpenChange }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-xl border-2 border-primary bg-background shadow-2xl"
        dir={isHe ? 'rtl' : 'ltr'}
        data-testid="booking-modal-content"
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-border bg-background rounded-t-xl">
